...
const About = ({ isEditing, content, setContent }: { isEditing: boolean, content: any, setContent: (c: any) => void }) => (
  <section id="about" className="py-[120px] lg:py-[160px] px-6 md:px-12 relative border-t border-black/5 min-h-screen flex items-center bg-[#FAFAFA] overflow-hidden">
