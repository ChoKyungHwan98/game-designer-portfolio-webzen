...
export const About = ({ isEditing, content, setContent }: AboutProps) => (
  ...
  >
    ...
    <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-[#B91C1C]/20 to-transparent" />
    ...
    <div className="max-w-7xl mx-auto w-full relative z-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-b border-black/5 pb-8">
        <div>
          <span className="text-[#B91C1C] font-sans text-[11px] font-bold tracking-widest uppercase mb-3 block">01. 소개</span>
          <h2 className="flex flex-col gap-1 items-start mt-2">
            ...
            <span className="flex items-baseline gap-2 leading-none mt-1">
              ...
              <span className="text-[82px] md:text-[100px] lg:text-[124px] font-display font-black tracking-tighter text-[#B91C1C] leading-none drop-shadow-[0_0_32px_rgba(0,71,187,0.22)]">+</span>
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-12 lg:gap-16 items-center">
        ...
        <div className="flex flex-col gap-10 lg:gap-14 justify-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="text-[20px] md:text-[24px] lg:text-[28px] font-semibold leading-[1.6] tracking-tight flex flex-col gap-2">
              ...
              >
                ...
                <span className="relative inline-block mt-1 md:mt-0">
                  <span className="font-black text-[#B91C1C]">'0'</span>에서 <span className="font-black text-[#B91C1C] drop-shadow-[0_0_8px_rgba(0,71,187,0.3)]">'+'</span>가 되는 경험
                  <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} viewport={{ once: true }} transition={{ delay: 0.5, duration: 0.6, ease: "easeOut" }} className="absolute -bottom-1 left-0 right-0 h-1.5 md:h-2 bg-[#B91C1C]/20 origin-left" />
                </span>으로 만드는 일입니다.
              </motion.div>
            </div>
            ...
            >
              ...
              유저의 마음에 즐거움이라는 <strong className="text-[#B91C1C] font-black">감성을 채워넣는 것</strong> —<br />
          ...
          >
            <div className="text-[18px] md:text-[22px] lg:text-[24px] leading-[1.6] font-bold text-[#1A1A1A] break-keep border-l-4 border-[#B91C1C] pl-4 md:pl-6 py-1
              [&_p]:m-0 [&_strong]:text-[#B91C1C]
            ">
              <EditableText
                value={content.p2} 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5">
          ...
          >
            <div className="absolute -right-12 -top-12 w-48 h-48 bg-[#B91C1C]/5 rounded-full blur-2xl group-hover:bg-[#B91C1C]/10 transition-colors"></div>
            <div className="flex items-center gap-6 relative z-10">
              <div className="w-16 h-16 rounded-full bg-[#B91C1C]/10 flex items-center justify-center shrink-0 group-hover:bg-[#B91C1C] group-hover:scale-110 transition-all duration-500">
                <span className="text-[#B91C1C] font-black text-3xl group-hover:text-white transition-colors duration-500">+</span>
              </div>
              <div>
                <p className="text-[12px] font-black tracking-widest text-[#B91C1C]/60 uppercase mb-2">재미 설계</p>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="bg-[#B91C1C] rounded-[32px] p-8 md:p-10 text-white shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 flex flex-col justify-end min-h-[220px] relative overflow-hidden group"
          >
          ...
          >
            <div className="absolute top-0 right-0 p-8">
              <span className="text-[64px] font-black leading-none opacity-5 group-hover:opacity-20 group-hover:scale-110 transition-all duration-500 block origin-top-right text-[#B91C1C]">A</span>
            </div>
            <div className="relative z-10 flex flex-col h-full justify-between">
              <span className="text-[32px] font-black leading-none block group-hover:text-[#B91C1C] transition-colors duration-500">A - Z</span>
              <div className="mt-8">
