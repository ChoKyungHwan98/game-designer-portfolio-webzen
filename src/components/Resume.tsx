            ...
            >
              ...
              <header className="flex flex-col md:flex-row items-center md:items-start gap-8 p-8 lg:p-12 bg-[#FAFAFA] border-b border-zinc-100">
                ...
                <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left pt-2">
                  ...
                  <p className="text-[#B91C1C] font-black font-mono tracking-[0.4em] text-[11px] lg:text-xs uppercase mb-6 pb-1 border-b-2 border-[#B91C1C]">
                    <EditableText value={data.role} onSave={(v) => setData({...data, role: v})} isEditing={isEditing} />
                  </p>
                  
                  <div className="max-w-2xl text-[16px] lg:text-[17px] text-[#2C2C2C] leading-[1.75] font-medium [&_strong]:text-[#B91C1C] [&_strong]:font-black [&_strong]:text-[17px] lg:[&_strong]:text-[18px] [&_strong]:bg-[#B91C1C]/5 [&_strong]:px-1.5 [&_strong]:py-0.5 [&_strong]:rounded-md break-keep">
                  ...
                  <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-3">
                    <div className="flex items-center gap-2.5 group">
                      <Mail className="w-4 h-4 text-[#B91C1C] shrink-0" strokeWidth={2} />
                    ...
                    {data.birthDate && (
                      <div className="flex items-center gap-2.5 group">
                        <Calendar className="w-4 h-4 text-[#B91C1C] shrink-0" strokeWidth={2} />
                        <div className="flex flex-col">
                    ...
                    {(isEditing || isGeneratingPdf) && data.phone && (
                      <div className="flex items-center gap-2.5 group">
                        <Phone className="w-4 h-4 text-[#B91C1C] shrink-0" strokeWidth={2} />
                        <div className="flex flex-col">
                    ...
                    {data.address && (
                      <div className="flex items-center gap-2.5 group">
                        <MapPin className="w-4 h-4 text-[#B91C1C] shrink-0" strokeWidth={2} />
                        <div className="flex flex-col">
                    ...
                    {data.military && (
                      <div className="flex items-center gap-2.5 group">
                        <Shield className="w-4 h-4 text-[#B91C1C] shrink-0" strokeWidth={2} />
                        <div className="flex flex-col">
                  ...
                  <div className="flex flex-col gap-12">
                    ...
                    <section>
                      <h3 className="text-[17px] font-bold mb-6 flex items-center gap-3 text-[#1A1A1A]">
                        <GraduationCap className="text-[#B91C1C] w-5 h-5" /> 학력 및 교육
                      </h3>
                      <div className="space-y-8">
                        {data.education.map((edu, idx) => (
                          <div key={idx} className="relative pl-6 border-l-2 border-[#B91C1C]/20">
                            <div className="absolute -left-[5px] top-1.5 w-2.5 h-2.5 rounded-none bg-[#B91C1C]/40"></div>
                    ...
                    <section>
                      <h3 className="text-[17px] font-bold mb-5 flex items-center gap-3 text-[#1A1A1A]">
                        <Award className="text-[#B91C1C] w-5 h-5" /> 자격증
                      </h3>
                      <div className="flex flex-col">
                            ...
                            <div className="flex items-center gap-4">
                              {cert.score && (
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span className="text-[12px] text-[#B91C1C] tabular-nums">{cert.score}</span>
                                </div>
                              )}
                              <div className="flex items-center gap-1.5">
                ...
                <main className="lg:col-span-8 p-8 lg:p-10 bg-white">
                  ...
                  <section>
                    <h3 className="text-[19px] font-bold mb-8 flex items-center gap-3 text-[#1A1A1A]">
                      <Briefcase className="text-[#B91C1C] w-6 h-6" /> 프로젝트 경험
                    </h3>
                    <div className="space-y-12">
                      {data.experience.map((exp, idx) => (
                        <div key={idx} className="relative pl-10 border-l-[3px] border-[#B91C1C]/10">
                          <div className="absolute -left-[10px] top-1.5 w-5 h-5 rounded-full bg-white border-4 border-[#B91C1C] shadow-sm"></div>
                          ...
                          <div className="text-[14px] text-[#B91C1C] font-bold mb-3 bg-[#B91C1C]/5 inline-block px-4 py-2 rounded-sm border-l-4 border-[#B91C1C]">
                          ...
                          <ul className="text-[14px] text-[#4A4A4A] space-y-3 list-none leading-relaxed font-medium">
                            {exp.details.map((detail, dIdx) => (
                              <li key={dIdx} className="relative pl-6">
                                <span className="absolute left-0 top-2 w-1.5 h-1.5 border border-[#B91C1C] rounded-full"></span>
                                {detail}
                              </li>
                            ))}
                          </ul>
                  ...
                  {data.tools && data.tools.length > 0 && (
                    <section className="mt-10 pt-10 border-t border-zinc-100">
                      <h3 className="text-[19px] font-bold mb-8 flex items-center gap-3 text-[#1A1A1A]">
                        <Wrench className="text-[#B91C1C] w-6 h-6" /> 기술 역량 및 도구
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                        {/* Group 1: Documentation & Office */}
                        <div className="space-y-5">
                          <h4 className="text-[10px] font-black text-[#B91C1C] tracking-[0.4em] uppercase border-b border-[#B91C1C]/10 pb-2 mb-3">DOCUMENTATION & OFFICE</h4>
                        ...
                        <div className="space-y-6">
                          <h4 className="text-[10px] font-black text-[#B91C1C] tracking-[0.4em] uppercase border-b border-[#B91C1C]/10 pb-2 mb-4">CREATIVE & ENGINE</h4>
                          <div className="space-y-4">
                            ...
                            <h4 className="text-[10px] font-black text-[#B91C1C] tracking-[0.4em] uppercase border-b border-[#B91C1C]/10 pb-2 mb-4 mt-8">AI ASSISTANTS</h4>
                            <div className="grid grid-cols-2 gap-4">
                              {data.tools.filter(t => ["ChatGPT", "Claude", "Gemini", "Antigravity"].includes(t.name)).map((tool, idx) => (
                                <div key={idx} className="flex items-center gap-2">
                                  <div className="w-1.5 h-1.5 rounded-full bg-[#B91C1C]/30" />
