    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-[#111] border border-[#2a2a2a] p-8 max-w-sm w-full shadow-xl rounded-2xl">
        ...
        <input 
          ...
          className="w-full bg-[#0a0a0a] border border-[#2a2a2a] p-3 text-[#e8e4dc] focus:outline-none focus:border-[#B91C1C] mb-6 font-mono rounded-lg"
          placeholder="••••"
          autoFocus
        />
        <div className="flex gap-4">
          ...
          <button onClick={() => onConfirm(password)} className="flex-1 py-3 bg-[#B91C1C] text-[#e8e4dc] font-bold hover:bg-[#9a0028] transition-colors rounded-xl">확인</button>
        </div>
      </div>
    </div>
  );
